...
const SAMPLE_TEXT = `This is line one.
This is line two.
...
export default function LineBreakRemoverPage() {
  ...
  const handleRemoveAll = () => {
    ...
    toast({ title: "Removed all line breaks" })
  }

  const handleRemoveExcess = () => {
    const result = inputText.replace(/\n{3,}/g, "\n\n").trim()
    setOutputText(result)
    toast({ title: "Removed excess line breaks" })
  }

  const handleSingleLine = () => {
    const result = inputText.replace(/\n+/g, "\n").trim()
    setOutputText(result)
    toast({ title: "Converted to single line breaks" })
  }
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <Breadcrumb className="mb-4 sm:mb-6">
              <BreadcrumbList className="text-xs sm:text-sm">
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Line Break Remover</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              ...
              <div className="flex-1">
                <h1 className="mb-2 sm:mb-3 text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight leading-tight">
                  Line Break Remover - Clean Up Text Online
                </h1>
                <p className="mb-3 sm:mb-4 text-sm sm:text-base md:text-lg text-muted-foreground">
                  Remove or reduce line breaks and format text. Perfect for cleaning up copied text or formatting documents.
                </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="my-6 flex flex-col items-center gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 w-full">
                  ...
                  <Button onClick={handleSingleLine} className="min-h-[48px]">
                    Single Breaks Only
                  </Button>
                  <Button onClick={handleRemoveExcess} className="min-h-[48px]">
                    Remove Excess Only
                  </Button>
                </div>
              </div>
              ...
              <Card className="mt-8">
                <CardHeader>
                  <CardTitle>About Line Break Remover</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 text-muted-foreground">
                  <p>
                    Remove unwanted line breaks from your text. This tool is perfect for cleaning up text copied from PDFs, emails, or documents that have excessive line breaks.
                  </p>
                  <p>
                    <strong>Options:</strong> Remove all line breaks to create a single paragraph, keep single line breaks only, or remove excessive multiple line breaks while keeping paragraph structure.
                  </p>
                </CardContent>
              </Card>
            </div>
